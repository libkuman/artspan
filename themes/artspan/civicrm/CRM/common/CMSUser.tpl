...
{if $showCMS }{*true if is_cms_user field is set *}
	 ...
	 <div class="form-layout-compressed">
	    <div class="cms_name-section">
	       <div class="label">{$form.cms_name.label}</div>
	       <div class="content">{$form.cms_name.html} <a id="checkavailability" href="#" onClick="return false;">{ts}<strong>Check Availability</strong>{/ts}</a>
	    ...
	    {if $form.cms_pass}
	       <div class="cms_pass-section">
	          <div class="label">{$form.cms_pass.label}</div>
	          <div class="content">{$form.cms_pass.html}</div>
	       </div>        
	       <div class="crm_confirm_pass-section">
	          <div class="label">{$form.cms_confirm_pass.label}</div>
	          <div class="content">{$form.cms_confirm_pass.html}<br />

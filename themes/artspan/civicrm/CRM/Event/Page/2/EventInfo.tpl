...
<div class="vevent crm-block crm-event-info-form-block">
	...
	<div class="crm-section event_date_time-section">
        ...
        <div id="weekend_information">
          <div class="studio_weekend">2011 SF Open Studios Weekend Dates:</div>
          <p>
            <b>Weekend 1:</b> October 1 &amp; 2, 11am to 6pm<br>
            Mission, Noe Valley, Bernal Heights, Castro, Excelsior
          </p>
          <p>
            <b>Weekend 2:</b> October 8 &amp; 9, 11am to 6pm<br>
            Ocean Beach, Sunset, Richmond, Duboce, Eureka Valley, Hayes Valley, Haight, Upper Market, Diamond Heights,<br>
            Buena Vista, Mount Davidson, Twin Peaks, West Portal, Glen Park
          </p>
          <p>
            <b>Weekend 3:</b> October 15 &amp; 16, 11am to 6pm<br>
            SOMA, Tenderloin, Potrero Hill, Bayview
          </p>
          <p>
            <b>Weekend 4:</b> October 22 &amp; 23, 11am to 6pm<br>
            Fort Mason, Marina, Pacific Heights, Russian Hill, North Beach, Financial District
          </p>
          <p>
            <b>Weekend 5:</b> October 29 &amp; 30, 11am to 6pm<br>

...
{if $priceSet}
	...
	{include file="CRM/Price/Form/ParticipantCount.tpl"}
          <!-- <div class="label">Payment can be processed with a Credit Card (see below). Visa, MasterCard, Discover Card, or PayPal accepted.</div> -->
                     <div class="label"><strong>Due to a system error payment CANNOT BE PROCESSED with a Credit Card at this time. To pay by Credit Card please leave the "pay by check" option below checked to complete registration and then call the ArtSpan office at (415) 861-9838 to complete payment.</strong></div>
    </fieldset>
...
{else}
    {if $paidEvent}
        <div class="crm-section paid_event-section">
          ...
          <!-- <div class="label">Payment can be processed with a Credit Card (see below). Visa, MasterCard, Discover Card, or PayPal accepted.</div> -->
            <div class="label"><strong style="color: red;">Due to a system error payment CANNOT BE PROCESSED with a Credit Card at this time. To pay by Credit Card please leave the "pay by check" option below checked to complete registration and then call the ArtSpan office at (415) 861-9838 to complete payment.</strong>
        {if $form.is_pay_later}
            <div class="crm-section pay_later-section">
    	        <div class="label">&nbsp;</div>
                <div class="content">{$form.is_pay_later.html}&nbsp;{$form.is_pay_later.label}</div>

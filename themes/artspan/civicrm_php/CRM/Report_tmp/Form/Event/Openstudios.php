...
class CRM_Report_Form_Event_Openstudios extends CRM_Report_Form {
    ...
    function __construct( ) {
        ...
        //M7 UPDATE - Add contribution custom fields
        ...
        $query = 'SELECT id, table_name FROM civicrm_custom_group WHERE is_active = 1 AND extends = "Individual"';
        $dao = CRM_Core_DAO::executeQuery( $query );
        while ( $dao->fetch( ) ) {
        ...
        $this->_from = "
             ...
             LEFT JOIN civicrm_address {$this->_aliases['civicrm_address']}
                    ON {$this->_aliases['civicrm_contact']}.id = {$this->_aliases['civicrm_address']}.contact_id AND 
                       {$this->_aliases['civicrm_address']}.location_type_id = 8 

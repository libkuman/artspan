...
class CRM_Event_Form_Registration_ThankYou extends CRM_Event_Form_Registration
{
	...
	$this->assign( 'user_id', $user->uid );       
        ...
        if ($this->_params[0]['studio_weekend_no']) {
                $this->_params[0]['studio_weekend_no'];
                $term = taxonomy_get_term($this->_params[0]['studio_weekend_no']);
                $parents = taxonomy_get_parents($this->_params[0]['studio_weekend_no']);
        ...
        if ($this->_params[0]['studio_weekend_no_2']) {
                $this->_params[0]['studio_weekend_no_2'];
                $term = taxonomy_get_term($this->_params[0]['studio_weekend_no_2']);
                $parents = taxonomy_get_parents($this->_params[0]['studio_weekend_no_2']);
                foreach($parents as $getparent) {
                        $parent = $getparent;
                }
